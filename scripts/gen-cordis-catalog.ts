...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  desktopHost: 'client-side interface-typed browser service — packages/desktop/desktop-client/README.md owns the API',
  desktopRuntimeLaunch: 'launcher-provided optional boot-context transport override (DesktopRuntimeLaunch | undefined) — packages/desktop/desktop-jsonrpc-server/README.md owns the boot contract',
  desktopCredentialBridge: 'host-face interface value installed by the composing app bin before mount — packages/credentials/credentials-keychain/README.md owns the credential contract',
