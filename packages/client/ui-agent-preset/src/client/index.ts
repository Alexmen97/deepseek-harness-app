...
import { de, en, es, fr, it, ptBr, zh } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-agent-preset: settings row dictionaries')
