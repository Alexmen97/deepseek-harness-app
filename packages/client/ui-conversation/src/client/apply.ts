...
import { de, en, es, fr, it, NS, ptBr, zh, type ConversationKey } from './locales.ts'
...
export function apply(ctx: Context): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-conversation: dictionaries')
