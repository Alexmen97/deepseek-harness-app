...
import { de, en, es, fr, it, ptBr, zh, type SettingsKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-settings-general: dictionaries')
