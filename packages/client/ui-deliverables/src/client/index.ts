...
import { de, en, es, fr, it, NS, ptBr, zh, type DeliverablesKey } from './locales.ts'
import {
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-deliverables: dictionaries')
  ctx.slots.inject(
