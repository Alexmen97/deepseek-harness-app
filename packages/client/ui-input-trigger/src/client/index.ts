...
import { de, en, es, fr, it, ptBr, zh, type MenuKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(MENU_NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-input-trigger: menu dictionaries')
