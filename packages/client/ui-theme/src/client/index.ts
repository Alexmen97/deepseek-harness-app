...
import { de, en, es, fr, it, ptBr, zh, type ThemeKey } from './locales.ts'
import {
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(SETTINGS_NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-theme: settings row dictionaries')
