...
import { de, en, es, fr, it, NS, ptBr, type WorkflowRunKey, zh } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-workflow-run: dictionaries')
