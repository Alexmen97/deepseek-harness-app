...
import { de, en, es, fr, it, ptBr, zh, type ModelKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-model-selection: dictionaries')
