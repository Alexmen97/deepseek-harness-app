...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ...
      ['it', {
        'browser.title': 'Seleziona directory area di lavoro',
        'browser.home': 'Home',
        ...
        'browser.truncated': 'Troppe cartelle da elencare; viene mostrato solo l’inizio.',
        'browser.showHidden': 'Mostra file nascosti',
      }],
      ['es', {
        'browser.title': 'Seleccionar directorio del área de trabajo',
        'browser.home': 'Inicio',
        ...
        'browser.truncated': 'Hay demasiadas carpetas para mostrarlas; solo se muestra el principio.',
      ...
      ['de', {
        ...
        'browser.truncated': 'Zu viele Ordner zum Auflisten; nur der Anfang wird angezeigt.',
