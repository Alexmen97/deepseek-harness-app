...
import { de, en, es, fr, it, ptBr, zh, type QuestionKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'ui-user-questions: dictionaries')
