...
import { de, en, es, fr, it, NS, ptBr, zh, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, it, es, fr, de, 'pt-BR': ptBr }), 'session-log-download: browser dictionaries')
