...
export type DesktopStringKey =
  ...
  | 'changes.unstageHunk'
  | 'changes.discardHunk'
  | 'changes.discardHunkTitle'
  | 'changes.discardHunkConsequence'
  | 'changes.hunkStale'
  | 'changes.hunkNotFound'
  | 'changes.hunkUnsupported'
  | 'changes.hunkApplyFailed'
  | 'terminal.noSession'
  | 'terminal.new'
  | 'terminal.close'
  | 'terminal.inputHint'
...
export const en: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Stage Hunk',
  'changes.unstageHunk': 'Unstage Hunk',
  'changes.discardHunk': 'Discard Hunk',
  'changes.discardHunkTitle': 'Discard this hunk?',
  'changes.discardHunkConsequence': 'This reverts the selected hunk in the worktree. Other unstaged and staged changes remain untouched.',
  'changes.hunkStale': 'The diff changed. Refresh and try again.',
  'changes.hunkNotFound': 'This hunk no longer exists in the current diff.',
  'changes.hunkUnsupported': 'Hunk actions are not available for this file.',
  'changes.hunkApplyFailed': 'The hunk could not be applied.',
...
export const it: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Stage hunk',
  'changes.unstageHunk': 'Unstage hunk',
  'changes.discardHunk': 'Scarta hunk',
  'changes.discardHunkTitle': 'Scartare questo hunk?',
  'changes.discardHunkConsequence': 'Questo ripristina l’hunk selezionato nel worktree. Le altre modifiche non in stage e quelle in stage restano intatte.',
  'changes.hunkStale': 'La diff è cambiata. Aggiorna e riprova.',
  'changes.hunkNotFound': 'Questo hunk non esiste più nella diff corrente.',
  'changes.hunkUnsupported': 'Le azioni hunk non sono disponibili per questo file.',
  'changes.hunkApplyFailed': 'Impossibile applicare l’hunk.',
...
export const zh: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': '暂存块',
  'changes.unstageHunk': '取消暂存块',
  'changes.discardHunk': '丢弃块',
  'changes.discardHunkTitle': '丢弃此块？',
  'changes.discardHunkConsequence': '此操作将还原工作区中选中的块。其他未暂存和已暂存的更改保持不变。',
  'changes.hunkStale': '差异已更改。请刷新后重试。',
  'changes.hunkNotFound': '此块在当前差异中已不存在。',
  'changes.hunkUnsupported': '此文件不支持块操作。',
  'changes.hunkApplyFailed': '无法应用此块。',
...
export const es: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Escenificar bloque',
  'changes.unstageHunk': 'Quitar bloque del stage',
  'changes.discardHunk': 'Descartar bloque',
  'changes.discardHunkTitle': '¿Descartar este bloque?',
  'changes.discardHunkConsequence': 'Esto revierte el bloque seleccionado en el directorio de trabajo. Los demás cambios sin escenificar y escenificados permanecen intactos.',
  'changes.hunkStale': 'La diferencia ha cambiado. Actualiza e inténtalo de nuevo.',
  'changes.hunkNotFound': 'Este bloque ya no existe en la diferencia actual.',
  'changes.hunkUnsupported': 'Las acciones de bloque no están disponibles para este archivo.',
  'changes.hunkApplyFailed': 'No se pudo aplicar el bloque.',
...
export const fr: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Indexer la section',
  'changes.unstageHunk': 'Retirer la section de l’index',
  'changes.discardHunk': 'Annuler la section',
  'changes.discardHunkTitle': 'Annuler cette section ?',
  'changes.discardHunkConsequence': 'Cela rétablit la section sélectionnée dans le répertoire de travail. Les autres modifications indexées et non indexées restent intactes.',
  'changes.hunkStale': 'La différence a changé. Actualisez et réessayez.',
  'changes.hunkNotFound': 'Cette section n’existe plus dans la différence actuelle.',
  'changes.hunkUnsupported': 'Les actions de section ne sont pas disponibles pour ce fichier.',
  'changes.hunkApplyFailed': 'Impossible d’appliquer la section.',
...
export const de: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Abschnitt stagen',
  'changes.unstageHunk': 'Abschnitt unstagen',
  'changes.discardHunk': 'Abschnitt verwerfen',
  'changes.discardHunkTitle': 'Diesen Abschnitt verwerfen?',
  'changes.discardHunkConsequence': 'Dies stellt den ausgewählten Abschnitt im Arbeitsverzeichnis wieder her. Andere ungestagte und gestagte Änderungen bleiben unberührt.',
  'changes.hunkStale': 'Der Diff hat sich geändert. Aktualisieren und erneut versuchen.',
  'changes.hunkNotFound': 'Dieser Abschnitt existiert im aktuellen Diff nicht mehr.',
  'changes.hunkUnsupported': 'Abschnittsaktionen sind für diese Datei nicht verfügbar.',
  'changes.hunkApplyFailed': 'Der Abschnitt konnte nicht angewendet werden.',
...
export const ptBr: Record<DesktopStringKey, string> = {
  ...
  'changes.stageHunk': 'Adicionar bloco ao stage',
  'changes.unstageHunk': 'Remover bloco do stage',
  'changes.discardHunk': 'Descartar bloco',
  'changes.discardHunkTitle': 'Descartar este bloco?',
  'changes.discardHunkConsequence': 'Isso reverte o bloco selecionado no diretório de trabalho. As demais alterações não encenadas e encenadas permanecem intactas.',
  'changes.hunkStale': 'A diff mudou. Atualize e tente novamente.',
  'changes.hunkNotFound': 'Este bloco não existe mais na diff atual.',
  'changes.hunkUnsupported': 'Ações de bloco não estão disponíveis para este arquivo.',
  'changes.hunkApplyFailed': 'Não foi possível aplicar o bloco.',
