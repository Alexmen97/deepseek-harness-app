...
function fakeBindings(options: { workspace?: string; configured?: boolean } = {}): {
  ...
  const host: FakeHost = {
    ...
    gitDiffFile: async () => ({ diff: '', tooLarge: false, binary: false, diffToken: '0000000000000000' }),
    gitDiscardFile: vi.fn(async () => {}),
    gitUnstageFile: vi.fn(async () => {}),
    gitStageHunk: vi.fn(async () => ({ diffToken: '0000000000000000' })),
    gitUnstageHunk: vi.fn(async () => ({ diffToken: '0000000000000000' })),
    gitDiscardHunk: vi.fn(async () => ({ diffToken: '0000000000000000' })),
